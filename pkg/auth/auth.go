...
import (
	...
	"github.com/hyperversal-blocks/bmlloopbe/pkg/jwt"
	"github.com/hyperversal-blocks/bmlloopbe/pkg/signer"
...
type auth struct {
	...
	Store       store.Store
	JWT         jwt.JWT
	userService adopter.Service
}

func New(signer signer.Signer, store store.Store, JWT jwt.JWT, userService adopter.Service) Auth {
